...
- Images: downloaded by `scripts/fetch_images.py` into `app/static/img/cities/`; credits recorded in `data/image_credits.json` and displayed on `/credits`. Never hotlink.
